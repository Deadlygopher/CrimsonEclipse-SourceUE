...
protected:
	...
	void OnJoinSessionCompete(FName SessionName, EOnJoinSessionCompleteResult::Type Result);
...
private:
	...
	//Bind our MultiplayerSessionsSubsystem internal callbacks to these
	//
	...
	FOnJoinSessionCompleteDelegate JoinSessionCompeteDelegate;
	FDelegateHandle JoinSessionCompeteDelegateHandle;
